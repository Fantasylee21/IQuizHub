  ...
  <div class="GroupPage">
    ...
    <div class="top">
      ...
      <div class="groupSelect">
        ...
        <el-button color="#666" style="margin-top: 20px" class="elb" @click="createGroupModalVisible = true">创建属于我的群组</el-button>
      </div>
    </div>
    <div class="allBlock"
      ...
      <div class="block" @click="navigateToDetail(item.id)" >
        <el-container>
          <el-aside width="100px">
            <div class="picture">
              <el-image src="https://pic2.zhimg.com/v2-0dda71bc9ced142bf7bb2d6adbebe4f0_r.jpg?source=1940ef5c">
              </el-image>
            </div>
          </el-aside>
          <el-main>
